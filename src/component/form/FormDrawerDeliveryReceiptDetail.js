...
const FormDrawerDeliveryReceiptDetail = ({
  open,
  setOpen,
  title,
  id,
  ...
  const { data: Merchandise } = useAsync(() =>
    ServicesMerchandise.getAllMerchandise()
  );
      ...
      <Form layout="vertical" form={form} onFinish={onFinish} hideRequiredMark>
        <Row gutter={16}>
          <Col span={24}>
            ...
            >
              <Select placeholder="Chọn mặt hàng" disabled={id ? true : false}>
